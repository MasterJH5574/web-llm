...
tir_dispatch_dict = {
    ...
    tvm.ir.structural_hash(decode4_fp16): decode_sch_func(decode4_fp16),
    tvm.ir.structural_hash(decode5_fp16): decode_sch_func(decode5_fp16),
    tvm.ir.structural_hash(decode6_fp16): decode_sch_func(decode6_fp16),
